...
USER_OBJS	= $(USER_SRCS:.c=.o) src/startup_stm32l1xx_md.o

# Set Include Paths
INCLUDES 	= -ILibraries/STM32L1xx_StdPeriph_Driver/inc/ \
...
DEFINES 	= -DSTM32L1XX -DUSE_STDPERIPH_DRIVER
